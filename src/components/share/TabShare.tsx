...
const TabShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    "I found this useful home renovation calculator tool, check it out: https://seosaurus.in/tools/home-renovation-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/home-renovation-calculator/";
